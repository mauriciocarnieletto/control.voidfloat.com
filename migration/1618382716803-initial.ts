...
export class initial1618382716803 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "pod_configuration_field" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "configurationType" varchar NOT NULL, "key" varchar(100) NOT NULL, "value" varchar(100) NOT NULL, "name" varchar(100) NOT NULL, "description" varchar(500) NOT NULL, "type" varchar NOT NULL, "listOptions" varchar, "functionName" varchar, "numberMin" integer, "numberMax" integer, "isAdvanced" boolean NOT NULL DEFAULT (0), "isShownOnCard" boolean NOT NULL DEFAULT (0), "isShownOnSessionScreen" boolean NOT NULL DEFAULT (0), "order" integer)`,
    );
    await queryRunner.query(
